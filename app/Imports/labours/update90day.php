    ...
    */
    ...
    public function collection(Collection $rows)
    {
        ...
        foreach ($rowData as $key => $row) {
            ...
            //row 2
            $dateValue = Carbon::createFromTimestamp(($row[2] - 25569) * 86400)->format('Y-m-d'); // ตำแหน่งข้อมูลวันที่อยู่ที่คอลัมน์ที่ 2
            $rowData[$key][2] = $dateValue; // กำหนดค่าวันที่ที่ถูกแปลงกลับไปยังคอลัมน์ที่ 2
        }
