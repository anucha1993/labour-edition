            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-table"></i> ข้อมูลคนต่างด้าว <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{route('labour.index')}}">ข้อมูลคนต่างด้าว</a></li>
                      {{-- <li><a href="tables_dynamic.html">Table Dynamic</a></li> --}}
                    </ul>
                  </li>
                  <li><a><i class="fa fa-group"></i>กลุ่มนำเข้าแรงงานต่างด้าว<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                  ...
                  <li><a><i class="fa fa-bar-chart-o"></i>รายงาน<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{route('report.reportAll')}}">รายงานข้อมูลคนต่างด้าวทั้งหมด</a></li>
                    </ul>
                  </li>
...
{{-- 
        ...
        <footer>
          <div class="pull-right">
            Foreign Worker Employment Agency The First Good Man Group Company Limited <a href="https://colorlib.com">Mr.Anucha Yothanan</a>
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
