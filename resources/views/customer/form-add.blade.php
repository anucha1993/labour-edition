...
@endif
        ...
        <div class="col-md-12 col-sm-12 ">
            <div class="x_panel">
                <div class="x_title">
                    <h2 class="text-success">เพิ่มข้อมูลนายจ้าง<small></small></h2>
                    ...
                    <form action="{{ route('customer.store') }}" method="post">
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-md-8 col-sm-8 ">
                                    <input type="text" class="form-control" id="company_zipcode" placeholder="ชื่อบริษัท" required
                                        name="company_name">
                                </div>

                            </div>
                            <div class="form-group row">
                                <label class="col-form-label col-md-2 col-sm-2 ">ทะเบียนบริษัทเลขที่ :
                                </label>

                                <div class="col-md-8 col-sm-8 ">
                                    <input type="text" class="form-control" id="company_code"
                                        placeholder="ทะเบียนบริษัทเลขที่" name="company_code">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4 col-sm-4 ">
                                    <input type="text" class="form-control" id="company_surname" placeholder="ชื่อ" required
                                        name="company_surname">
                                </div>
                                <div class="col-md-4 col-sm-4 ">
                                    <input type="text" class="form-control" id="company_lastname" placeholder="นามสกุล" required
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8 col-sm-8 ">
                                    <input type="text" class="form-control" id="company_tel"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8 col-sm-8 ">
                                    <input type="text" class="form-control" id="company_email" placeholder="อีเมล์"
                                        name="company_email">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4 col-sm-4 ">
                                    <input type="text" class="form-control" id="company_authorized_surname_1"
                                        placeholder="ชื่อ" name="company_authorized_surname_1">
                                </div>
                                <div class="col-md-4 col-sm-4 ">
                                    <input type="text" class="form-control" id="company_authorized_lastname_1"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4 col-sm-4 ">
                                    <input type="text" class="form-control" id="company_authorized_surname_2"
                                        placeholder="ชื่อ" name="company_authorized_surname_2">
                                </div>
                                <div class="col-md-4 col-sm-4 ">
                                    <input type="text" class="form-control" id="company_authorized_lastname_2"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4 col-sm-4 ">
                                    <input type="text" class="form-control" id="company_authorized_surname_3"
                                        placeholder="ชื่อ" name="company_authorized_surname_3">
                                </div>
                                <div class="col-md-4 col-sm-4 ">
                                    <input type="text" class="form-control" id="company_authorized_lastname_3"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4 col-sm-4 ">
                                    <input type="text" class="form-control" id="company_authorized_surname_4"
                                        placeholder="ชื่อ" name="company_authorized_surname_4">
                                </div>
                                <div class="col-md-4 col-sm-4 ">
                                    <input type="text" class="form-control" id="company_authorized_lastname_4"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4 col-sm-4 ">
                                    <input type="text" class="form-control" id="company_authorized_surname_5"
                                        placeholder="ชื่อ" name="company_authorized_surname_5">
                                </div>
                                <div class="col-md-4 col-sm-4 ">
                                    <input type="text" class="form-control" id="company_authorized_lastname_5"
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-md-8 col-sm-8 ">
                                    <textarea name="company_house_number" class="form-control" cols="30" rows="3"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8 col-sm-8 ">
                                    <input type="text" name="company_business_type" class="form-control"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8 col-sm-8 ">
                                    <input type="text" name="company_coordinator" class="form-control"
                                        placeholder="ประเภทกิจการ">
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8 col-sm-8 ">
                                    <textarea name="company_note" class="form-control" cols="30" rows="7"></textarea>
                                </div>
                            </div>
