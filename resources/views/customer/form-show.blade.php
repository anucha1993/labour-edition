                ...
                <div class="x_content">
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-md-8 col-sm-8 ">
                                    <input type="text" class="form-control" id="company_name" placeholder="ชื่อบริษัท"
                                        name="company_name" value="{{$customer->company_name}}" disabled>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8 col-sm-8 ">
                                    <input type="text" class="form-control" id="company_code"
                                        placeholder="ทะเบียนบริษัทเลขที่" name="company_code" value="{{$customer->company_code}}" disabled>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4 col-sm-4 ">
                                    <input type="text" class="form-control" id="company_surname" placeholder="ชื่อ" value="{{$customer->company_surname}}"  disabled
                                        name="company_surname">
                                </div>
                                <div class="col-md-4 col-sm-4 "> 
                                    <input type="text" class="form-control" id="company_lastname" placeholder="นามสกุล" value="{{$customer->company_lastname}}" disabled
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8 col-sm-8 ">
                                    <input type="text" class="form-control" id="company_tel" value="{{$customer->company_tel}}"  disabled
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8 col-sm-8 ">
                                    <input type="text" class="form-control" id="company_fax" placeholder="แฟกซ์ 02" disabled
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8 col-sm-8 ">
                                    <input type="text" class="form-control" id="company_email" placeholder="อีเมล์"  value="{{$customer->company_email}}"  disabled
                                        name="company_email">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4 col-sm-4 ">
                                    <input type="text" class="form-control" id="company_authorized_surname_1"
                                        placeholder="ชื่อ" name="company_authorized_surname_1" value="{{$customer->company_authorized_surname_1}}"  disabled>
                                </div>
                                <div class="col-md-4 col-sm-4 ">
                                    <input type="text" class="form-control" id="company_authorized_lastname_1" value="{{$customer->company_authorized_lastname_1}}" disabled
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4 col-sm-4 ">
                                    <input type="text" class="form-control" id="company_authorized_surname_2" value= "{{$customer->company_authorized_surname_2}}"  disabled
                                        placeholder="ชื่อ" name="company_authorized_surname_2">
                                </div>
                                <div class="col-md-4 col-sm-4 ">
                                    <input type="text" class="form-control" id="company_authorized_lastname_2" value= "{{$customer->company_authorized_lastname_2}}"disabled
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4 col-sm-4 ">
                                    <input type="text" class="form-control" id="company_authorized_surname_3" value= "{{$customer->company_authorized_surname_3}}"disabled
                                        placeholder="ชื่อ" name="company_authorized_surname_3">
                                </div>
                                <div class="col-md-4 col-sm-4 ">
                                    <input type="text" class="form-control" id="company_authorized_lastname_3" value= "{{$customer->company_authorized_lastname_3}}"disabled
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4 col-sm-4 ">
                                    <input type="text" class="form-control" id="company_authorized_surname_4" value= "{{$customer->company_authorized_surname_4}}"disabled
                                        placeholder="ชื่อ" name="company_authorized_surname_4">
                                </div>
                                <div class="col-md-4 col-sm-4 ">
                                    <input type="text" class="form-control" id="company_authorized_lastname_4" value= "{{$customer->company_authorized_lastname_4}}"disabled
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4 col-sm-4 ">
                                    <input type="text" class="form-control" id="company_authorized_surname_5" value= "{{$customer->company_authorized_surname_5}}"disabled
                                        placeholder="ชื่อ" name="company_authorized_surname_5">
                                </div>
                                <div class="col-md-4 col-sm-4 ">
                                    <input type="text" class="form-control" id="company_authorized_lastname_5" value= "{{$customer->company_authorized_lastname_5}}"disabled
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-md-8 col-sm-8 ">
                                    <textarea name="company_house_number" class="form-control" cols="30" rows="3" disabled>{{$customer->company_house_number}}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8 col-sm-8 ">
                                    <select name="company_province" id="province" class="form-control" required disabled>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8 col-sm-8 ">
                                    <select name="company_area" id="amphur" class="form-control" disabled required>
                                        @php
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8 col-sm-8 ">
                                    <select name="company_district" id="district" class="form-control" disabled required>
                                        @php
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8 col-sm-8 ">
                                    <input type="text" name="company_zipcode" id="zipcode"  disabled class="form-control"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8 col-sm-8 ">
                                    <input type="text" name="company_business_type" class="form-control" disabled value="{{$customer->company_business_type}}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8 col-sm-8 ">
                                    <input type="text" name="company_coordinator" class="form-control" disabled value="{{$customer->company_coordinator}}"
                                        placeholder="ประเภทกิจการ">
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8 col-sm-8 ">
                                    <textarea name="company_note" class="form-control" cols="30" rows="7" disabled>{{$customer->company_note}}</textarea>
                                </div>
                            </div>
